...
import MyTagsModal from "./Components/my-tags-modal";
...
export default function Home() {
  return (
    <main className="sm:px-12 px-5 flex flex-col gap-14 pt-7 pb-20 md:h-screen bg-slate-50 dark:bg-slate-950">
      ...
      {/* Secciones y Tareas */}
      <div className="w-full flex md:flex-row justify-between lg:gap-16 gap-10 flex-col lg:px-24 sm:px-0 h-auto pb-20">
        <div className="w-full flex flex-col gap-5" id="por-hacer">
          <SectionName name="Por hacer" taskCounter={1}/>
          <TaskCard title="Tarea 1 de Estéfano" description="Esta es la tarea 1 del profe."/>
        </div>
