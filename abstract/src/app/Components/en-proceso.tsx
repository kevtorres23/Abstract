...
import { NotebookPen, Plus, Check, ArrowLeft } from "lucide-react"
import TaskCard from "./task-card";
import Tags from "./tags";

function SeccionEnProceso() {
            ...
            <div className="w-full flex flex-col gap-5">
                ...
                <div className="w-full sm:p-6 p-4 gap-5 flex flex-col bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-lg">
                    <div className="contenido w-full flex flex-col gap-5">
                        <div className="p-2 rounded-lg bg-main-blue-15 self-start"><NotebookPen className="text-main-blue hover:text-main-blue cursor-pointer" size={20} /></div>
...
export default SeccionEnProceso;